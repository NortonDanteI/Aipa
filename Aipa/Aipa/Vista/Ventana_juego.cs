...
namespace Aipa.Vista
{
    public partial class Ventana_juego : Form
    {
        ...
        #region Metodos basicos que inicializan una partida
        ...
        private void Start_Match()
        {
            ...
            agente = new Agente();
            agente.lstPiecesPlayer1 = lstPiecesPlayer1.ToList();
            agente.lstPiecesPlayer2 = lstPiecesPlayer2.ToList();
            Next_Turn(true);
        ...
        private void Set_MovesLocations()
            {// movimientos habilitados que posee la pieza
            this.Pieces.ForEach(x => x.Movimientos_permitidos = Get_MovesLocations(x, this.Pieces)); 
